(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      console.clear();
      console.log("[1;32m\n __    __ _           _                         \n/ /\\ /\\ \\ |__   __ _| |_ ___  __ _ _ __  _ __  \n\\ \\/  \\/ / '_ \\ / _` | __/ __|/ _` | '_ \\| '_ \\ \n \\  /\\  /| | | | (_| | |\\__ \\ (_| | |_) | |_) |\n  \\/  \\/ |_| |_|\\__,_|\\__|___/\\__,_| .__/| .__/ \n                                   |_|   |_|    \n<<============================================================>>\n[N+A] OWNER   : EXODIA\n[A+N] GITHUB  : BINOD ON FIRE \n[N+A] TOOL    : BINOD AUTOMATIC WHATSAPP MESSAGE SENDER\n<<============================================================>>");
    };
    let _0x524dbd = [];
    let _0x4d8ae4 = [];
    let _0x83eb79 = null;
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/twN01ZGT").then(_0x27e908 => {
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.link/khhe16?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
